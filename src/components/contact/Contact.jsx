...
export default function Contact() {
  ...
  const sendEmail = (e) => {
    e.preventDefault();
    emailjs.sendForm('gmail_jvenkiah', 'template_7gk3wq3', e.target, 'user_xdb9Fr0JUjCoYFOs4hiu4')
      .then((result) => {
    ...
    <div className="contact" id="contact">
      <h1>Contact</h1>
        ...
        <form ref={form} onSubmit={sendEmail}>
          ...
          <textarea name="message" id="message" cols="30" rows="7" className="form-control" required></textarea>
          <input type="submit" value="Send" className="g-recaptcha" data-sitekey="6LcN69AfAAAAAM8mxYEGvjt3EXlXWNmpzSVF6BgG"/>
